...
class Annealer(object):
    ...
    def __init__(self, initial_state: List[str]=None, load_state=None) -> None:
    ...
    def copy_state(self, state: List[str]) -> List[str]:
    ...
    def update(self, *args: int, **kwargs: float) -> None:
    ...
    def default_update(self, step: int, T: float, E: float, acceptance: Union[None, float], improvement: Union[None, float]) -> None:
    ...
    def anneal(self) -> Tuple[List[str], float]:
